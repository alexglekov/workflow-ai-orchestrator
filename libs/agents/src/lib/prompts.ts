...
11. LLM в рантайме берёт ключ из подключения llm или из GEMINI_API_KEY / QWEN_API_KEY. Не проси ключ у пользователя в questions, если коннектор llm есть в каталоге.
